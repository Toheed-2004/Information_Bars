...
from bitpredict.data.time_bars.kraken.fetcher import KrakenFetcher
...
def main():
    """
    Main entry point for the Kraken data downloader.
    ...
    setup_logging("data.ochlv.kraken")
