...
from fetcher import HyperliquidStreamManager
...
setup_logging("data.tick.hyperliquid")
...
def main():
    ...
    try:
        ...
        hyperliquid_configs = get_tick_meta(exchange='hyperliquid')
        ...
        systems: List[HyperliquidStreamManager] = []
        
        for db_config in hyperliquid_configs:
            ...
            system = HyperliquidStreamManager(config)
