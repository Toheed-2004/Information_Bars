...
def run_unit_test():
    ...
    df_signals = TestDataGenerator.generate_signals(df_bars[df_bars["datetime"] >= "2025-02-01"], frequency=test_cfg['signal_frequency'])
    ...
    # # print(type(daily_pf))
    # # print(hasattr(daily_pf, 'trades'))
    # # print(daily_pf.trades.records_readable.head() if hasattr(daily_pf, 'trades') else "NO TRADES")
    # # print(hasattr(daily_pf, 'bm_returns'))
    # # print(daily_pf.bm_returns)
    # # print(daily_pf.stats(benchmark_returns=daily_pf.bm_returns))

    # print(pf.stats())
    # print("\n\n\n")
    # # 1. Does daily_pf.stats() auto-use bm_returns internally?
    # print(daily_pf.stats())

    # # 2. What trade columns are available on original pf?
    # print(pf.trades.records_readable.columns.tolist())

    # # 3. Does original pf have these?
    # print(hasattr(pf.trades, 'mfe'))
    # print(hasattr(pf.trades, 'mae'))
